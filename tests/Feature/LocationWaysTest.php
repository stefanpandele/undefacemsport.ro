...
/**
 * A club teaching one sport at the given location.
 */
...
/**
 * A space at the given location, with hours every day.
 */
function spaceAt(Location $location, ?Sport $sport, SpaceAccessMode $mode, ?float $price, bool $managed = true): Space
{
    $presence = null;
